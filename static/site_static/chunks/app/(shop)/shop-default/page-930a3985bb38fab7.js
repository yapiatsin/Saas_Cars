(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
        ...
        5469: (e, s, l) => {
            ...
            function m() {
                ...
                return (0, i.useEffect)(() => {
                    let e = [];
                    if (x.length) {
                        let s = [...c.Kh].filter(e => x.some(s => e.filterBrands.includes(s)));
                        e = [...e, s]
                    }
                    if ("All" !== m) {
                        let s = [...c.Kh].filter(e => m ? e.inNew : !e.inNew);
                        e = [...e, s]
                    }
                    if ("All" !== p) {
                        if ("All Discounts" == p) {
                            let s = [...c.Kh].filter(e => e.oldPrice);
                            e = [...e, s]
                        }
                        if ("Today’s Deals" == p) {
                            let s = [...c.Kh].filter(e => e.isTodaysDeals);
                            e = [...e, s]
                        }
                    }
                    if ("All" !== h) {
                        let s = [...c.Kh].filter(e => e.rating >= h);
                        e = [...e, s]
                    }
                    let a = [...c.Kh].filter(e => e.price >= l[0] && e.price <= l[1]);
                    e = [...e, a], s({
                        type: "SET_FILTERED",
                        payload: [...c.Kh].filter(s => e.every(e => e.includes(s)))
                    })
                }, [l, m, p, h, x]), (0, i.useEffect)(() => {
                    "Price Ascending" === N ? s({
                        type: "SET_SORTED",
                        payload: [...f].sort((e, s) => e.price - s.price)
                    }) : "Price Descending" === N ? s({
                        type: "SET_SORTED",
                        payload: [...f].sort((e, s) => s.price - e.price)
                    }) : "Title Ascending" === N ? s({
                        type: "SET_SORTED",
                        payload: [...f].sort((e, s) => e.title.localeCompare(s.title))
                    }) : "Title Descending" === N ? s({
                        type: "SET_SORTED",
                        payload: [...f].sort((e, s) => s.title.localeCompare(e.title))
                    }) : s({
                        type: "SET_SORTED",
                        payload: f
                    }), s({
                    ...
                    children: (0, a.jsx)("div", {
                        ...
                        children: (0, a.jsxs)("div", {
                            ...
                            children: [(0, a.jsx)("div", {
                                className: "canvas-filter-product sidebar-filter handle-canvas left",
                                children: (0, a.jsxs)("div", {
                                    className: "canvas-wrapper",
                                    children: [(0, a.jsxs)("div", {
                                        className: "canvas-header d-flex d-xl-none",
                                        children: [(0, a.jsx)("h5", {
                                            className: "title",
                                            children: "Filter"
                                        }), (0, a.jsx)("span", {
                                        ...
                                        className: "canvas-bottom d-flex d-xl-none",
                                ...
                                children: [(0, a.jsxs)("div", {
                                    ...
                                    children: [(0, a.jsxs)("div", {
                                        ...
                                        children: [(0, a.jsx)(o.A, {}), (0, a.jsx)(r.A, {}), (0, a.jsxs)("div", {
                                ...
                                }), 0 != l[0] || 100 != l[1] || "All" != m || "All" != p || "All" != h || x.length ? (0, a.jsxs)("div", {
    ...
    e => {
        var s = s => e(e.s = s);
        e.O(0, [5270, 2357, 2331, 2867, 31, 5120, 2120, 8441, 1684, 7358], () => s(1145)), _N_E = e.O()
    }
]);